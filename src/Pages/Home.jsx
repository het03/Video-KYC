      ...
      <section className="flex items-center bg-white dark:bg-gray-900 h-screen">
        <div className="container text-left mx-auto grid gap-16 items-start py-8 px-4 max-w-screen-xl lg:grid-cols-2 lg:py-16 lg:px-6">
          <div className="font-light text-gray-500 sm:text-lg dark:text-gray-400">
            <h2 className="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Welcome to Video KYC</h2>
            <p className="mb-4">Fast, Secure, and User-Friendly Verification at Your Fingertips</p>
            <p>Join the revolution in customer onboarding with our state-of-the-art Video KYC solution. Experience a seamless verification process that’s as easy as having a conversation.</p>
